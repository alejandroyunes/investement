    ...
    <section>
      ...
      <div {...stylex.props(s.container)}>
        ...
        <div>
          ...
          <h3 {...stylex.props(s.description)}> Entrust your vacation home to our expert care and enjoy the benefits while we handle all property needs. As Your Trusted Partner in Real Estate, Property Management, and Construction Support, we ensure your property is always guest-ready. Our dedicated team manages cleaning, maintenance, and repairs with a second-to-none approach, turning your property into a welcoming haven.</h3>
        </div>
      </div>
      ...
      <div {...stylex.props(s.container)}>
        ...
        <div>
          ...
          <h3 {...stylex.props(s.description)}>Receive expert construction support from planning to completion. Our commitment to quality craftsmanship ensures your project meets high standards, delivered on time and within budget. Leveraging local expertise, we provide informed recommendations and navigate challenges. For dreamers of construction projects, our third branch offers steadfast support, turning visions into reality with comprehensive assistance. Trust us for a seamless, successful construction journey.</h3>
        </div>
      </div>
